...
function report_feedback_tracker_print_row($mod, $instance, $result) {
    global $OUTPUT, $CFG;
 ...
 */
function report_feedback_tracker_get_common_log_variables() {
    global $DB;
 ...
 */
function report_feedback_tracker_user_outline($userid, $cmid, $module, $instanceid) {
    global $DB;

    list($uselegacyreader, $useinternalreader, $minloginternalreader, $logtable) = report_feedback_tracker_get_common_log_variables();
 ...
 * @return string
 */
function report_feedback_tracker_user_complete($userid, $cmid, $module, $instanceid) {
    global $DB;
    ...
    if (!empty($strnumviews) && (!empty($lastlogtime))) {
        ...
        return get_string('neverseen', 'report_feedback_tracker');
    }
}
