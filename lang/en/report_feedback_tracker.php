...
$string['closure:currentyear-3'] = 'Closure dates 3 years ago';
$string['closure:currentyear-4'] = 'Closure dates 4 years ago';
$string['closure:currentyear-5'] = 'Closure dates 5 years ago';
$string['closure:easter_end'] = 'Easter Closure end date';
$string['closure:easter_end_info'] = 'The last day of Easter closure';
$string['closure:easter_start'] = 'Easter Closure start date';
$string['closure:easter_start_info'] = 'The first day of Easter closure';
$string['closure:xmas_end'] = 'Christmas Closure end date';
$string['closure:xmas_end_info'] = 'The last day of Christmas closure';
$string['closure:xmas_start'] = 'Christmas Closure start date';
$string['closure:xmas_start_info'] = 'The first day of Christmas closure';
...
$string['feedback:late'] = 'Released late';
$string['feedback:notreleased'] = 'Not released';
$string['feedback:overdue'] = 'Overdue';
$string['feedback:released'] = 'Released';
...
$string['feedbackduedate:custom'] = 'Set manually';
...
$string['header:customfeedbackduedate'] = 'Add custom feedback due date';
$string['header:customfeedbackreleaseddate'] = 'Add custom feedback released date';
$string['header:duedate'] = 'Due';
$string['header:edit'] = 'Edit';
$string['header:feedbackdue'] = 'Feedback due';
$string['header:feedbackduedate'] = 'Feedback due date';
$string['header:feedbackreleaseddate'] = 'Feedback released date';
...
$string['header:hiddenfromstudents'] = 'Hide from student report';
$string['header:mark'] = 'Mark';
$string['header:marking'] = 'Marking';
$string['header:method'] = 'Feedback method';
$string['header:newfeedbackduedate'] = 'New feedback due date';
...
$string['settings:datesheading'] = 'Dates';
$string['settings:defaultdate'] = '01 Jan 1970';
$string['settings:export_academicyear'] = 'Academic year for exported data';
$string['settings:export_academicyearinfo'] = 'This will determine for which academic year data will be exported. Leave empty for current academic year.';
$string['settings:export_limit'] = 'Export limit';
$string['settings:export_limitinfo'] = 'Maximum number of records to export. Leave empty for no limit.';
$string['settings:export_path'] = 'Path to export file';
$string['settings:export_pathinfo'] = 'Path to the exported data file. Leave empty for temp data.';
$string['settings:exportheading'] = 'Export data settings';
...
$string['settings:showusermarkings'] = 'Show user markings only';
$string['settings:showusermarkingsdescription'] = 'Where applicable show only submissions and markings in reports the user is responsible for (e.g. Courseworks)';
$string['settings:sitereport'] = 'Use site report';
...
$string['settings:supportworkshop'] = 'Workshops';
...
$string['studentreport'] = 'View your student report';
