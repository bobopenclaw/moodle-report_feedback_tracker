...
$string['formative:tooltip'] = 'This formative assessment will <i>not</i> count towards the overall course mark.';
...
$string['navigationlink'] = 'MyAssessments';
$string['pleasenote'] = 'Please note:';
$string['pluginname'] = 'MyAssessments';
